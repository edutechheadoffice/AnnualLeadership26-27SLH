      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center">
            <a
              href="#activities"
              className="inline-flex items-center justify-center gap-1 bg-brand-blue-dark hover:bg-brand-blue text-brand-white px-5 py-2 rounded-full text-xs uppercase font-bold tracking-wider shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300"
            >
              Activity Center
